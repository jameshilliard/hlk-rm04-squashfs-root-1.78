...
<table width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  <tr>
    <td class="title" colspan="2" id="setmanLoadFactDefault">System Reboot</td>
  </tr>
  <tr>
    <td class="head" id="setmanLoadFactDefaultButton">System Reboot Button</td>
    <td><input value="Reboot" id="setmanLoadDefault" name="LoadDefault" style="{width:120px;}" type="submit"></td>
  </tr>
</table>
</form>
