...
function initTranslation()
{
	...
	e = document.getElementById("manAdmWatchDog");
	e.innerHTML = _("man admin watchdog");
	e = document.getElementById("manAdmwatchdogEnabled");
	e.innerHTML = _("admin enable");
	e = document.getElementById("manAdmwatchdogDisabled");
	...
	e = document.getElementById("setmanRebootF");
	e.innerHTML = _("setman system reboot");
	e = document.getElementById("setmanRebootButton");
	e.innerHTML = _("setman reboot button");
	e = document.getElementById("setmanReboot");
	e.value = _("setman reboot");
...
function initValue()
{
	...
	if (watchdogb == "1") {
		document.getElementById("div_watchdog").style.visibility = "visible";
		document.getElementById("div_watchdog").style.display = style_display_on();
		...
		document.getElementById("div_watchdog").style.visibility = "hidden";
...
/*
	if (snortb == "1")
	{
		var snort_enable = "<% getCfgGeneral(1, "SnortEnable"); %>";
		document.getElementById("div_snort").style.visibility = "visible";
		document.getElementById("div_snort").style.display = style_display_on();
		document.getElementById("div_snort_submit").style.visibility = "visible";
		document.getElementById("div_snort_submit").style.display = style_display_on();
	...
	{
		document.getElementById("div_snort").style.visibility = "hidden";
		document.getElementById("div_snort").style.display = "none";
		document.getElementById("div_snort_submit").style.visibility = "hidden";
		document.getElementById("div_snort_submit").style.display = "none";
	}
*/
}
...
<form method="post" name="LoadDefaultSettings" action="/goform/Sys_Reboot">
<table width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  <tr>
    <td class="title" colspan="2" id="setmanRebootF">System Reboot</td>
  </tr>
  <tr>
    <td class="head" id="setmanRebootButton">System Reboot Button</td>
    <td><input value="Reboot" id="setmanReboot" name="LoadDefault" style="{width:120px;}" type="submit"></td>
  </tr>
</table>
</form>
...
<table style="display:none"  width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
<tbody><tr>
...
<table style="display:none"  width="540" border="0" cellpadding="2" cellspacing="1">
  <tr align="center">
    <td>
...
<table style="display:none"  id="div_greenap" width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
  <tr>
...
<table style="display:none"  id="div_greenap_submit" width="540" border="0" cellpadding="2" cellspacing="1">
  <tr align="center">
    <td>
...
<table style="display:none"  id="div_ddns" width="540" border="1" cellspacing="1" cellpadding="3" bordercolor="#9BABBD">
<tbody><tr>
...
<table style="display:none"  id="div_ddns_submit" width="540" border="0" cellpadding="2" cellspacing="1">
  <tr align="center">
    <td>
...
<table id="div_snort_submit" width="540" border="0" cellpadding="2" cellspacing="1">
  <tr align="center">
    <td>
      <input type="submit" style="{width:120px;}" value="Apply" id="manSnortApply">&nbsp;&nbsp;
