...
function back_() 
{
	...
	window.location.href='/ser2net.asp';
}

function rescan_() 
{
//	window.location.href='./scaning.asp';
	var par='./wifi_list1.asp';
...
//	var par='./wifi_config.asp'+'?ch='+ch+'&ssid='+ssid+'&bssid='+bssid+'&sec='+sec;
	//var par='./wifi_config.asp'+'?ch='+ch+'&ssid='+ssid+'&sec='+sec;
...
var wifi_conf_array;
	...
	if(sec.indexOf('WPA2PSK') != -1){
		...
		if(sec.indexOf('AES') != -1){
			wifi_conf_array= "wpa2_aes";
		} 
		else if(sec.indexOf('TKIP') != -1){
			wifi_conf_array= "wpa2_tkip";
		}
		else{
		}
	}
		...
		if(sec.indexOf('AES') != -1){
			wifi_conf_array= "wpa_aes";
		} 
		else if(sec.indexOf('TKIP') != -1){
			wifi_conf_array= "wpa_tkip";
		}
		else{
		}
	}
		...
		wifi_conf_array= "none";
	}

	par= par+'&enc_type='+wifi_conf_array;
...
<input name="Submit" value="取消" type="button"  onClick="back_()">

</td>
	    <td width="40%"  align="center" >
<input name="Submit" value="重新扫描" type="button"  onClick="rescan_()">
	    </td>
	    <td width="30%"   align="center">
<input name="Submit" value="确定" type="button"  onClick="next_()">
	    </td>
  </tr>
</table>
	</td>
