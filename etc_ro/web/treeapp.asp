...
<body bgcolor=#3B5685 onLoad="initValue()">
...
<form method="post" name="Lang" action="/goform/setSysLang">
 &nbsp;&nbsp;<input type="image" style="{width:54px;}" src="graphics/en.gif" onClick="return setLanguageEnglish()">&nbsp;
	     ...
	     <input type="image" style="{width:54px;}" src="graphics/zhtw.gif" onClick="return setLanguageTraChinese()">
...
if ((opmode == '0' && dpbsta == '1' && ethconv == '1') || opmode == '2')
{
	...
	if (ad == '1')
		a.add(410, 400, "Antenna Diversity",			"javascript:go('wireless/ant_diversity.asp');");
...
else
{
	...
	a.add(408, 400, _("treeapp statistics"),            "javascript:go('wireless/apstatistics.asp');");
	if (ad == '1')
		a.add(409, 400, "Antenna Diversity",		"javascript:go('wireless/ant_diversity.asp');");
	if (meshb == "1")
...
if (usbb == "1")
{
	...
	if (storageb == "1")
	{
		...
		if (ftpb == "1")
			a.add(853, 850, _("treeapp ftpsrv"),		"javascript:go('usb/FTPftpsrv.asp');");
		if (smbb == "1")
			a.add(854, 850, _("treeapp sambasrv"),		"javascript:go('usb/SAMBAsmbsrv.asp');");
		if (mediab == "1")
