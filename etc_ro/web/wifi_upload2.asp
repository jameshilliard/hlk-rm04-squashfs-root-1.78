...
document.write('<div id="loading" style="display: none;"><br><br><br>Uploading firmware <br><br> Please be patient and don\'t remove device if it presented...</div>');
...
<h1 id="uploadTitle">Upgrade Firmware(<% ser2netconfig_get("ver"); %>)</h1>
<p><font id="uploadIntroduction1">Upgrade the HLK-RM04 firmware to obtain new functionality. </font><font id="uploadIntroduction2" color="#ff0000">It takes about 1 minute to upload &amp; upgrade flash and be patient please. Caution! A corrupted image will hang up the system.</font> </p>
( WiFi)
