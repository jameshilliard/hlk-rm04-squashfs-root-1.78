...
<h1>HLK-RM04 Serial2Net Settings:UART 2</h1>
<p></p>
<hr />
...
<td><% ser2netconfig_get("C2_mode"); %>(0:None,1:Server,2:Client)</td>
<td><select size="1" name="C2_mode" id="C2_mode"  onChange="ser2netMode_Changed()"><option value="1">Server</option><option value="2">Client</option><option value="0">None</option></select>
</td></tr>
...
<td><% ser2netconfig_get("C2_protocol"); %>(0:None,1:TCP,2:UDP)</td>
